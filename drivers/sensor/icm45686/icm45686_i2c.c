...
int icm45686_read_mreg(const struct i2c_dt_spec *bus, uint16_t reg,
...
int icm45686_write_mreg(const struct i2c_dt_spec *bus, uint16_t reg,
				 uint8_t buf)
{
	int res;
	uint8_t reg_pwr_mgmt0;
...
int icm45686_update_mreg(const struct i2c_dt_spec *bus, uint16_t reg, uint8_t mask,
				 uint8_t data)
{
	uint8_t temp = 0;
