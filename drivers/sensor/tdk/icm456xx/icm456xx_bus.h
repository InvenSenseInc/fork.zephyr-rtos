...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM456xx_BUS_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM456xx_BUS_H_
...
static inline int icm456xx_bus_read(const struct device *dev,
				    uint8_t reg,
				    uint8_t *buf,
				    uint16_t len)
{
...
static inline int icm456xx_bus_write(const struct device *dev,
				     uint8_t reg,
				     const uint8_t *buf,
				     uint16_t len)
{
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ICM456xx_BUS_H_ */
