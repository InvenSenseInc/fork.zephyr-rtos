...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM456XX_TRIGGER_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM456XX_TRIGGER_H_
...
/**
 * @brief initialize the icm456xx trigger system
 *
 * @param dev icm456xx device pointer
...
/**
 * @brief lock access to the icm456xx device driver
 *
 * @param dev icm456xx device pointer
 */
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ICM456XX_TRIGGER_H_ */
