...
#define ICP201XX_CONFIG(inst)                                                                      \
	IF_ENABLED(CONFIG_ICP201XX_TRIGGER,	                                  \
				(.gpio_int = GPIO_DT_SPEC_INST_GET_OR(inst, int_gpios, {0}),)) .op_mode = DT_INST_ENUM_IDX(inst, op_mode),                    \
...
#define ICP201XX_CONFIG_I2C(inst)                                                                  \
	{                                                                                          \
		.if_mode = ICP201XX_IF_I2C, .bus.i2c = I2C_DT_SPEC_INST_GET(inst),                 \
		.bus_io = &icp201xx_bus_io_i2c, ICP201XX_CONFIG(inst)                              \
	}
...
#define ICP201XX_CONFIG_SPI(inst)                                                                  \
	{                                                                                          \
		...
		.bus.spi = SPI_DT_SPEC_INST_GET(inst,                                              \
						...
						0),                                                \
		.bus_io = &icp201xx_bus_io_spi, ICP201XX_CONFIG(inst)                              \
	}
...
#define ICP201XX_DEFINE(inst)                                                                      \
	...
	static const struct icp201xx_config icp201xx_config_##inst = COND_CODE_1(DT_INST_ON_BUS(inst, spi),	                                      \
