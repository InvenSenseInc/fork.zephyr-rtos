...
#ifndef _INV_IMU_REGMAP_REV_B_H_
#define _INV_IMU_REGMAP_REV_B_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @file inv_imu_regmap_rev_b.h
...
#define APEX_CONFIG2_MREG1                                                 0x46
#define APEX_CONFIG3_MREG1                                                 0x47
#define APEX_CONFIG4_MREG1                                                 0x48
#define APEX_CONFIG5_MREG1                                                 0x49
#define APEX_CONFIG9_MREG1                                                 0x4a
#define APEX_CONFIG10_MREG1                                                0x4b
#define APEX_CONFIG11_MREG1                                                0x4c
#define ACCEL_WOM_X_THR_MREG1                                              0x4d
#define ACCEL_WOM_Y_THR_MREG1                                              0x4e
#define ACCEL_WOM_Z_THR_MREG1                                              0x4f
#define OFFSET_USER0_MREG1                                                 0x50
#define OFFSET_USER1_MREG1                                                 0x51
#define OFFSET_USER2_MREG1                                                 0x52
#define OFFSET_USER3_MREG1                                                 0x53
#define OFFSET_USER4_MREG1                                                 0x54
#define OFFSET_USER5_MREG1                                                 0x55
#define OFFSET_USER6_MREG1                                                 0x56
#define OFFSET_USER7_MREG1                                                 0x57
#define OFFSET_USER8_MREG1                                                 0x58
#define ST_STATUS1_MREG1                                                   0x66
#define ST_STATUS2_MREG1                                                   0x67
#define FDR_CONFIG_MREG1                                                   0x69
#define APEX_CONFIG12_MREG1                                                0x6a
 ...
 * This register field should not be programmed in I3C/DDR mode
 */
#define DRIVE_CONFIG1_I2C_SLEW_RATE_POS      0x06
#define DRIVE_CONFIG1_I2C_SLEW_RATE_MASK     (0x03 << DRIVE_CONFIG1_I2C_SLEW_RATE_POS)
 ...
 * This register field should not be programmed in I3C/DDR mode
 */
#define DRIVE_CONFIG2_I2C_SLEW_RATE_POS      0x06
#define DRIVE_CONFIG2_I2C_SLEW_RATE_MASK     (0x01 << DRIVE_CONFIG2_I2C_SLEW_RATE_POS)

/*
 * pads_i3c_od_slew_trim 
 * Configure drive strength of AP SDA pin when chip is in I3C SDR protocol open drain mode.
 * [2:0]: Fall time spec (typical values [ns] at 3.3V/30pF)
 * 3’b000: 70
 * 3’b001: 37
 * 3’b010: 28
 * 3’b011: 20
 ...
 * 3'b101: 7
 * 3'b11-: 1
 * This register should not be programmed in I3C/DDR. Change is taking effect after CSB (of SPI mode) or after STOP (of I2C mode or I3C/SDR mode).
 */
#define DRIVE_CONFIG2_PADS_I3C_OD_SLEW_TRIM_POS      0x03
#define DRIVE_CONFIG2_PADS_I3C_OD_SLEW_TRIM_MASK     (0x07 << DRIVE_CONFIG2_PADS_I3C_OD_SLEW_TRIM_POS)
 ...
 * All sensor operations should be disabled before programming the reg_otp_reload to kick off OTP reload operation. 
 * Host should read reg_otp_done till it returns a value of 1 to indicate the OTP reload operation has completed.
 * After otp_done is 1, host should reconfigure the chip to resume the intended operation. 
...
#endif  /*#ifndef _INV_IMU_REGMAP_REV_B_H_*/
